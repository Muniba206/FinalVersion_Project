...
public class Client  {
	...
	public boolean start() {
		...
		// If it failed not much can be done
		catch(Exception ec) {
	...
	private void display(String msg) {
		if(cg == null)
			...
			cg.append(msg + "\n");		// append to the ClientGUI JTextArea (or something)
	}
	...
	private void disconnect() {
		...
		catch(Exception e) {} // not much can be done
		try {
	...
	class ListenFromServer extends Thread {
		...
		public void run() {
			while(true) {
				...
				// Can't happen with a String object but still need to catch it
